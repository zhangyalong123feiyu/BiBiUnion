...
public class MessageHelper {
	...
	public static VisitorInfo createVisitorInfo() {
		...
		info.nickName(Preferences.getInstance().getNickName())
		    .name(Constants.loginresultInfo.getUser().getName())
		    .qq("暂无")  //qq号
			.phone(Constants.loginresultInfo.getUser().getEnterprise().getContactCellphone()) //手机号
		    .companyName(Constants.loginresultInfo.getUser().getEnterprise().getEnterpriseName()) //企业名称
		    .description("")
		    .email("暂无");  //邮箱
		return info;
	}
