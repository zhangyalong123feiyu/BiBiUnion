...
public class PrivateAeraAdapter extends RecyclerView.Adapter<PrivateAeraAdapter.PrivateViewHolder> {
    ...
    holder.areaTextview.setText(area[position]);
        ...
        holder.areaTextview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                areaOnclickListioner.onAearClickListioner(v, isCancel);
   ...
   public interface AreaOnclickListioner{void onAearClickListioner(View view, boolean isCancel);
    }
    ...
    public void setSelectAreaTest(String text){
        for(int i=0 ; i<area.length ; i++){
            if(area[i].equals(text)){
                clickPos = i;
            }
        }
        notifyDataSetChanged();
