 ...
 */
//首页弹出工具类
public class HomePopWindowUtils implements PopupWindow.OnDismissListener {
    ...
    private View icon;
    public HomePopWindowUtils(Context context, TextView projectInfo, View icon/*, TextView projectNameOne, TextView projectNameTwo, TextView projectNameThree*/) {
